...
const allowedOrigins = (process.env.CORS_ORIGIN || 'http://localhost:4002,http://192.168.10.8:3333,http://localhost:3334,http://192.168.10.8:3334,http://localhost:3335,http://192.168.0.110:3335,http://localhost:3336,http://192.168.0.110:3336,http://localhost:3337,http://192.168.0.110:3337')
  .split(',')
